...
//$themeReplace['site_name'] = $_SERVER['HTTP_HOST'].' free web proxy';
$themeReplace['site_name'] = 'GetMeProxy.com free web proxy';

// Meta description
$themeReplace['meta_description'] = <<<OUT
Get Me Proxy - is a free online proxy service which helps people to be anonymous when required to be so or for example get access to censored websites, in some cases it may help to bypass some types of limitations on random services.
OUT;

// Meta keywords (separate with comma)
$themeReplace['meta_keywords'] = <<<OUT
	free proxy, anonymity service, anonymizer, hide ip, access to censored websites
OUT;

// Proxy description text
$themeReplace['description'] = <<<OUT
   <p>Get Me Proxy - is a free online proxy service which helps people to be anonymous when required to be so or for example get access to censored websites, in some cases it may help to bypass some types of limitations on random services.</p>
OUT;
